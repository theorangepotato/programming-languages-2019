-- Interpreter for LambdaNat4
-- numbers and conditionals and recursion
...
evalCBV (ELet i e1 e2) = evalCBV (EApp (EAbs i e2) e1) 
evalCBV (ERec i e1 e2) = evalCBV (EApp (EAbs i e2) (EFix (EAbs i e1)))
evalCBV (EFix e) = evalCBN (EApp e (EFix e)) -- looks like a hack to use CBN here
evalCBV (EMinusOne e) = case (evalCBV e) of
    ENat0 -> ENat0
    (ENatS e) -> e
...
evalCBN (EFix e) = evalCBN (EApp e (EFix e)) -- can we do this without adding EFix to the grammar?
