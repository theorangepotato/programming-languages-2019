...
instance Print AbsLambdaNat.Exp where
  prt i e = case e of
    ...
    AbsLambdaNat.EVar id -> prPrec i 3 (concatD [prt 0 id])
    AbsLambdaNat.ENat nat -> prPrec i 4 (concatD [prt 0 nat])

instance Print AbsLambdaNat.Nat where
  prt i e = case e of
    AbsLambdaNat.Nat0 -> prPrec i 0 (concatD [doc (showString "0")])
    AbsLambdaNat.NatS nat -> prPrec i 0 (concatD [doc (showString "S"), prt 0 nat])
