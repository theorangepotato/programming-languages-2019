...
instance Print AbsLambdaNat.Exp where
  prt i e = case e of
    ...
    AbsLambdaNat.ELet id exp1 exp2 -> prPrec i 2 (concatD [doc (showString "let"), prt 0 id, doc (showString "="), prt 0 exp1, doc (showString "in"), prt 0 exp2])
    AbsLambdaNat.ERec id exp1 exp2 -> prPrec i 2 (concatD [doc (showString "let"), doc (showString "rec"), prt 0 id, doc (showString "="), prt 0 exp1, doc (showString "in"), prt 0 exp2])
    ...
    AbsLambdaNat.EVar id -> prPrec i 5 (concatD [prt 0 id])
